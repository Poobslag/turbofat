...
Parameters:
	'customer_def': The colors and textures used to draw the customer.
"""
...
Parameters:
	'fatness_percent': Controls how fat the customer should be; 5.0 = 5x normal size
...
Parameters:
	'customer_index': (Optional) The customer to ask about. Defaults to the current customer.
"""
