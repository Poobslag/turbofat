...
func test_prune_one() -> void:
	_level_history.add("level_895", rank_result(7890))
...
func test_prune_two() -> void:
	_level_history.add("level_895", rank_result(7890))
	_level_history.add("level_895", rank_result(6780))
	_level_history.prune("level_895")
...
func test_prune_many() -> void:
	_level_history.add("level_895", rank_result(500))
	_level_history.add("level_895", rank_result(700))
	_level_history.add("level_895", rank_result(30))
	_level_history.add("level_895", rank_result(10))
	_level_history.add("level_895", rank_result(600))
	_level_history.add("level_895", rank_result(20))
	_level_history.add("level_895", rank_result(40))
...
func test_no_level_name() -> void:
	_level_history.add("", rank_result())
	assert_false(_level_history.level_names().has(""))


func test_daily_best_no_duplicates() -> void:
	_level_history.add("level_895", rank_result(1285))
	_level_history.add("level_895", rank_result(1230))
