...
func test_calculate_rank_marathon_300_mixed() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.speed_rank), "S+")
	assert_eq(RankCalculator.grade_from_rank(rank.lines_rank), "A+")
	assert_eq(RankCalculator.grade_from_rank(rank.box_score_per_line_rank), "S+")
	assert_eq(RankCalculator.grade_from_rank(rank.combo_score_per_line_rank), "S-")
	assert_eq(RankCalculator.grade_from_rank(rank.score_rank), "AA+")
...
func test_calculate_rank_marathon_lenient() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.speed_rank), "S+")
	assert_eq(RankCalculator.grade_from_rank(rank.lines_rank), "AA+")
	assert_eq(RankCalculator.grade_from_rank(rank.box_score_per_line_rank), "S+")
	assert_eq(RankCalculator.grade_from_rank(rank.combo_score_per_line_rank), "S-")
	assert_eq(RankCalculator.grade_from_rank(rank.score_rank), "AA+")
...
func test_calculate_rank_40_pieces() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.pieces_rank), "S+")
...
func test_calculate_rank_1_piece() -> void:
	...
	assert_eq(RankCalculator.grade_from_rank(rank.pieces_rank), "-")
...
func test_calculate_rank_sprint_120_top_out() -> void:
	...
	assert_eq(RankCalculator.grade_from_rank(rank1.speed_rank), "SS+")
	assert_eq(RankCalculator.grade_from_rank(rank1.lines_rank), "SS+")
	assert_eq(RankCalculator.grade_from_rank(rank1.box_score_per_line_rank), "S")
	assert_eq(RankCalculator.grade_from_rank(rank1.combo_score_per_line_rank), "SS")
	assert_eq(RankCalculator.grade_from_rank(rank1.score_rank), "S+")
	...
	assert_eq(RankCalculator.grade_from_rank(rank2.speed_rank), "SS+")
	assert_eq(RankCalculator.grade_from_rank(rank2.lines_rank), "SS+")
	assert_eq(RankCalculator.grade_from_rank(rank2.box_score_per_line_rank), "S")
	assert_eq(RankCalculator.grade_from_rank(rank2.combo_score_per_line_rank), "SS")
	assert_eq(RankCalculator.grade_from_rank(rank2.score_rank), "S+")
...
func test_calculate_rank_ultra_200() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.speed_rank), "SS+")
	assert_eq(RankCalculator.grade_from_rank(rank.box_score_per_line_rank), "M")
	assert_eq(rank.combo_score_per_line, 20.0)
	assert_eq(RankCalculator.grade_from_rank(rank.combo_score_per_line_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.seconds_rank), "SS+")
...
func test_calculate_rank_ultra_200_overshot() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.speed_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.box_score_per_line_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.combo_score_per_line_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.seconds_rank), "SSS")
...
func test_calculate_rank_ultra_1() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.seconds_rank), "AA")
...
func test_calculate_rank_five_creatures() -> void:
	...
	var rank1 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank1.lines_rank), "SSS")
	assert_eq(RankCalculator.grade_from_rank(rank1.box_score_per_line_rank), "S+")
	assert_eq(RankCalculator.grade_from_rank(rank1.combo_score_per_line_rank), "S")
	assert_eq(RankCalculator.grade_from_rank(rank1.score_rank), "SS")
	...
	var rank2 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank2.lines_rank), "A-")
	assert_eq(RankCalculator.grade_from_rank(rank2.box_score_per_line_rank), "AA")
	assert_eq(RankCalculator.grade_from_rank(rank2.combo_score_per_line_rank), "A")
	assert_eq(RankCalculator.grade_from_rank(rank2.score_rank), "A+")
...
func test_success_bonus_score() -> void:
	...
	var rank1 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank1.score_rank), "AA+")
...
func test_success_bonus_seconds() -> void:
	...
	var rank1 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank1.seconds_rank), "S-")

	# the player achieves the success condition; they get a better grade
	CurrentLevel.settings.set_success_condition(Milestone.TIME_UNDER, 300)
	var rank2 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank2.seconds_rank), "S+")
...
func test_customer_combo() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.score_rank), "M")
...
func test_unranked() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.seconds_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.score_rank), "M")
...
func test_unranked_loss() -> void:
	...
	var rank := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank.seconds_rank), "-")
	assert_eq(RankCalculator.grade_from_rank(rank.score_rank), "-")
...
func test_extra_seconds_per_piece() -> void:
	...
	var rank2 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank2.speed_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank2.score_rank), "SS")
...
func test_box_factor_zero() -> void:
	...
	var rank1 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank1.box_score_per_line_rank), "A+")
	
	CurrentLevel.settings.rank.box_factor = 0.0
	var rank2 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank2.box_score_per_line_rank), "M")
...
func test_combo_factor_zero() -> void:
	...
	var rank1 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank1.combo_score_per_line_rank), "A+")
	
	CurrentLevel.settings.rank.combo_factor = 0.0
	var rank2 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank2.combo_score_per_line_rank), "M")
...
func test_master_pickup_score() -> void:
	...
	var rank1 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank1.pickup_score_rank), "M")

	CurrentLevel.settings.rank.master_pickup_score = 200
	var rank2 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank2.pickup_score_rank), "AA")
...
func test_master_pickup_score_per_line() -> void:
	...
	var rank2 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank2.pickup_score_rank), "S-")
...
func test_very_short_level() -> void:
	...
	var rank2 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank2.score_rank), "SSS")
...
func test_preplaced_pieces_ultra() -> void:
	...
	var rank1 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank1.seconds_rank), "M")
	...
	assert_eq(RankCalculator.grade_from_rank(rank3.seconds_rank), "M")
...
func test_preplaced_pieces_sprint() -> void:
	...
	var rank1 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank1.score_rank), "M")
	...
	var rank3 := _rank_calculator.calculate_rank()
	assert_eq(RankCalculator.grade_from_rank(rank3.score_rank), "M")
...
func test_calculate_rank_lines_m() -> void:
	...
	assert_eq(RankCalculator.grade_from_rank(rank.box_score_per_line_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.combo_score_per_line_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.pickup_score_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.lines_rank), "M")
	assert_eq(RankCalculator.grade_from_rank(rank.score_rank), "M")
