...
func test_pretty_string_keys() -> void:
	...
	assert_eq(KeybindManager.pretty_string({"type": "key", "keycode": 0}), "")
	assert_eq(KeybindManager.pretty_string({"type": "key", "keycode": 82}), "R")
	assert_eq(KeybindManager.pretty_string({"type": "key", "keycode": 16777231}), "Left")
