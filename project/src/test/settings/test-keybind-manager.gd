...
func test_pretty_string_keys() -> void:
	...
	assert_eq(KeybindManager.pretty_string({"type": "key", "scancode": 4194319}), "Left")
...
func test_pretty_string_joypad_buttons() -> void:
	...
	assert_eq(KeybindManager.pretty_string({"type": "joypad_button", "device": 0, "button_index": 10}), "R")
	assert_eq(KeybindManager.pretty_string({"type": "joypad_button", "device": 0, "button_index": 13}), "D-Pad Left")
	assert_eq(KeybindManager.pretty_string({"type": "joypad_button", "device": 0, "button_index": 91}), "Joypad Button 91")
