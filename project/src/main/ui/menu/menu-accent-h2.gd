...
const TEXTURES_BY_ACCENT_WIDTH := {
	...
	AccentWidth.SMALL: [
		preload("res://assets/main/ui/menu/menu-accent-h2-s1.png"),
		preload("res://assets/main/ui/menu/menu-accent-h2-s2.png"),
		preload("res://assets/main/ui/menu/menu-accent-h2-s3.png"),
	],
	AccentWidth.MEDIUM: [
		preload("res://assets/main/ui/menu/menu-accent-h2-m1.png"),
		preload("res://assets/main/ui/menu/menu-accent-h2-m2.png"),
		preload("res://assets/main/ui/menu/menu-accent-h2-m3.png"),
	],
	AccentWidth.LARGE: [
		preload("res://assets/main/ui/menu/menu-accent-h2-l1.png"),
		preload("res://assets/main/ui/menu/menu-accent-h2-l2.png"),
		preload("res://assets/main/ui/menu/menu-accent-h2-l3.png"),
	],
	AccentWidth.XL: [
		preload("res://assets/main/ui/menu/menu-accent-h2-xl1.png"),
		preload("res://assets/main/ui/menu/menu-accent-h2-xl2.png"),
...
func _refresh_accent_width() -> void:
	...
	elif string_width < 130:
		_accent_width = AccentWidth.MEDIUM
	elif string_width < 230:
