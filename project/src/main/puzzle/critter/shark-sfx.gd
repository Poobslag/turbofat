...
func play_voice_friendly_sound() -> void:
	...
	_voice_friendly.pitch_scale = randf_range(pitch_scale * 0.9, pitch_scale * 1.1)
...
func play_voice_short_sound() -> void:
	...
	_voice_short.pitch_scale = randf_range(pitch_scale * 0.9, pitch_scale * 1.1)
	SfxDeconflicter.play(_voice_short)


## Plays a sustained eating sound, like a grinding saw.
func play_eat_sound() -> void:
	var pitch_scale_start := randf_range(pitch_scale * 0.9, pitch_scale * 1.1)
...
func play_bite_sound() -> void:
	_bite.pitch_scale = randf_range(pitch_scale * 0.95, pitch_scale * 1.05)
