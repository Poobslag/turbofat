...
/**
 * Recolors and draws an outline around a sprite.
 *
 * Unlike outline.shader, the icon outline is sampled in 24 directions by default, and can be further increased for
 * very large or intricate sprites.
 */
