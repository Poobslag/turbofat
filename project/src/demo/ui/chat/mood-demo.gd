...
func _input(event: InputEvent) -> void:
	if Input.is_key_pressed(KEY_SHIFT):
		...
		match Utils.key_scancode(event):
			...
			KEY_H: $Creature.play_mood(Creatures.Mood.SMILE0)
			KEY_J: $Creature.play_mood(Creatures.Mood.SMILE1)
			KEY_K: $Creature.play_mood(Creatures.Mood.SWEAT0)
			KEY_L: $Creature.play_mood(Creatures.Mood.SWEAT1)
			KEY_Z: $Creature.play_mood(Creatures.Mood.THINK0)
			KEY_X: $Creature.play_mood(Creatures.Mood.THINK1)
			KEY_C: $Creature.play_mood(Creatures.Mood.WAVE0)
			KEY_V: $Creature.play_mood(Creatures.Mood.WAVE1)
			KEY_B: $Creature.play_mood(Creatures.Mood.YES0)
			KEY_N: $Creature.play_mood(Creatures.Mood.YES1)
