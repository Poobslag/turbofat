...
## perfect score and then other goals are calculated based on a percentage of the perfect score. The more granular
## fields such as "box_score_per_line_rank" are no longer needed by these newer algorithms.
