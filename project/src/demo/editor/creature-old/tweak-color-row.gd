...
func _on_RainbowDna_pressed() -> void:
	_creature_editor.tweak_all_creatures(allele, CreatureEditorOld.RANDOM_COLORS)


func _on_PurpleDna_pressed() -> void:
	_creature_editor.tweak_all_creatures(allele, CreatureEditorOld.THEME_COLORS)


func _on_GreyDna_pressed() -> void:
	_creature_editor.tweak_all_creatures(allele, CreatureEditorOld.SIMILAR_COLORS)
