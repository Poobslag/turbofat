class_name CreatureEditorOld
extends Node
## Graphical creature editor which lets players design their own creatures.
##
## This version was used in the game until June 2024 when the new editor came out. It includes some advanced
## randomization features not present in the new editor which are useful for generating new monsters.
