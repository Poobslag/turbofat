...
tr("Yes yes, okay.")
tr("Also, you can sort of cheat if you want to, by lowering the difficulty.")
tr("Isn't that cheating?")
tr("Will it really count?")
tr("But I'm so close!")
tr("I already lowered it!")
tr("Cheats? Isn't that cheating?")
...
tr("I already lowered the difficulty! I'm cheating as much as I can cheat!")
tr("Mmm that's very honorable of you. Sometimes, it's honorable to know when to cheat, and to know when to not cheat.")
tr("I don't remember agreeing to this, this kind of 'honorable cheat'!")
