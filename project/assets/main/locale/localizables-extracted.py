...
tr("Goodbye Skins!")
tr("Goodbye Skins! ...I'll miss you the most of all!")
tr("Hello Bones!")
...
tr("Oh! Goodbye!")
tr("Hello Everyone!")
tr("Let's meet the employees of our Merrymellow Marsh location!")
...
tr("... ...")
tr("... ... ...")
tr("Well... I wouldn't eat it. Did you have any cooking experience before this?")
tr("Uhh I mean like, Richie's been helping me figure out the kitchen stuff. ...Did I mess something up?")
tr("Hmm. Yes! Pretty good. Your rhythm's ahhh... a little off though!")
tr("My... my rhythm?")
tr("Yes!/ That food should be coming out like pap-/pap-/pap-/pap-/pap!/ Right now you're more like pappap,// pappa/ pap.")
tr("You don't want to give them any break. Eating should become an unconscious reflex to them, like blinking!")
tr("What I think #player# is trying to say is your rhythm is ahhh... a little off.")
tr("My... my rhythm?")
tr("Yes!/ That food should be coming out like pap-/pap-/pap-/pap-/pap!/ Right now you're more like pappap,// pappa/ pap.")
tr("You don't want to give them a break. Eating should become an unconscious reflex to them, like blinking!")
tr("Oh, hmm... okay. Mowr...")
...
tr("Hello Skins!")
tr("Let's get to know Skins a little better.")
tr("Hmm... just like before.")
tr("Yeah...")
tr("Mowr... Any tips?")
tr("I don't know, I'm kind of at a loss on this one. #sensei#? Why isn't it working?")
tr("Was it their technique or... were they too slow? They didn't seem slow to me.")
tr("Ahh well. Their cooking skills are improving, so... Maybe it's just a matter of time.")
tr("The customers will come back, and next time they'll stay longer! So, let's be patient.")
...
tr("C'mon Skins, you can do this! We believe in you!")
